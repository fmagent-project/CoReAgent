...
class MiniMaxACPAgent:
    ...
    async def newSession(self, params: NewSessionRequest) -> NewSessionResponse:
        ...
        agent = Agent(llm_client=self._llm, system_prompt=self._system_prompt, tools=tools, max_steps=self._config.agent.max_steps, token_limit=self._config.llm.token_limit, workspace_dir=str(workspace))
